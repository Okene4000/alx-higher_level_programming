...
def matrix_divided(matrix, div):
    """ this function divides the integer or float numbers of a matrix
    Args:
        matrix: list of a lists of integers/floats
        div: number that divides the matrix
    Returns:
         new matrix accompanied with the result of the division
    Raises:
        TypeError: If the elements of the matrix are not lists
                   If the div is not an integer or a float
